...
public class ComposeEmailViewModel : ViewModelBase
{
    ...
    public ComposeEmailViewModel()
    {
        ...
        _errorHandlingService = Program.ServiceProvider?.GetRequiredService<IErrorHandlingService>()
    ...
    private async Task LoadEmailAccountsAsync()
    {
        ...
        {
            _errorHandlingService.HandleException(ex, "Load Email Accounts");
        }
    }
    ...
    private async Task LoadEmailForReplyAsync(Guid emailId)
    {
        ...
        {
            _errorHandlingService.HandleException(ex, "Load Email for Reply");
        }
    }
    ...
    private async Task LoadEmailForForwardAsync(Guid emailId)
    {
        ...
        {
            _errorHandlingService.HandleException(ex, "Load Email for Forward");
        }
    }
    ...
    private async Task SendEmailAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            _errorHandlingService.HandleException(ex, "Send Email");
    ...
    private async Task AddAttachmentAsync()
    {
        ...
        {
            _errorHandlingService.HandleException(ex, "Add Attachment");
        }
    }
