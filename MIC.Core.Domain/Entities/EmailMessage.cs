...
public class EmailMessage : BaseEntity
{
    ...
    public void SetCopyRecipients(string? ccRecipients, string? bccRecipients)
    {
        CcRecipients = string.IsNullOrWhiteSpace(ccRecipients) ? null : ccRecipients;
        BccRecipients = string.IsNullOrWhiteSpace(bccRecipients) ? null : bccRecipients;
    }
