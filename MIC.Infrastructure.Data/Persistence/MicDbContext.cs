...
public class MicDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ConfigureSettingHistory(modelBuilder);
    ...
    private void ConfigureSettings(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Setting>(entity =>
        {
            ...
            entity.Property(e => e.SyncStatus)
                .IsRequired()
                .HasMaxLength(20)
                .HasDefaultValue(Setting.SyncStatuses.Local);
    ...
    private void ConfigureSettingHistory(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<SettingHistory>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.SettingId, e.ChangedAt });
        });
    }
