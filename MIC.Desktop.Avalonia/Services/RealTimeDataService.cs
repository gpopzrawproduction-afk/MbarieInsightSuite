...
public class RealTimeDataService : IDisposable
{
    ...
    public void Start()
    {
        ...
        NotificationService.Instance.ShowSuccess("Real-time updates enabled", "Connected", "Realtime");
    ...
    public async Task RefreshNowAsync()
    {
        ...
        NotificationService.Instance.ShowInfo("Data refreshed", "Sync Complete", "Sync");
    }
        ...
        while (!ct.IsCancellationRequested)
        {
            ...
            catch (Exception ex)
            {
                Program.ServiceProvider?
                    .GetService<IErrorHandlingService>()?
                    .HandleException(ex, "Real-time data refresh");
    ...
    public void PublishAlert(string title, string message, string severity)
    {
        ...
        {
            NotificationService.Instance.ShowError(message, title, "Alerts");
        }
        else if (severity == "Warning")
        {
            NotificationService.Instance.ShowWarning(message, title, "Alerts");
        }
        else
        {
            NotificationService.Instance.ShowInfo(message, title, "Alerts");
        }
    }
