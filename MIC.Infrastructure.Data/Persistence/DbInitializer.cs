...
public async Task InitializeAsync(CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (!await CanConnectToDatabaseAsync(cancellationToken))
            {
                ...
                throw new DatabaseException(
                    ...
                    "Could not connect to the database. Please verify the configuration.");
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new DatabaseException(
                                "Database schema mismatch. Run migrations or enable RunMigrationsOnStartup.",
                                "Database schema mismatch detected. Run migrations or enable automatic migrations.");
                        }
                    }
                }
            }
        ...
        catch (Exception ex)
        {
            ...
            throw new DatabaseException("Database initialization failed.", null, ex);
        }
    }
