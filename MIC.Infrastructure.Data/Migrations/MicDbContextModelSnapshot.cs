...
namespace MIC.Infrastructure.Data.Migrations
{
    ...
    partial class MicDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MIC.Core.Domain.Entities.Setting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MIC.Core.Domain.Entities.SettingHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("SettingId", "ChangedAt");

                    b.ToTable("SettingHistory");
                });

            modelBuilder.Entity("MIC.Core.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MIC.Core.Domain.Entities.SettingHistory", b =>
                {
                    b.HasOne("MIC.Core.Domain.Entities.Setting", "Setting")
                        .WithMany("History")
