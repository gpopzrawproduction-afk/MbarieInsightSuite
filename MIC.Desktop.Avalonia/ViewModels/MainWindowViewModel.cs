...
public class MainWindowViewModel : ViewModelBase, INotifyPropertyChanged
{
        ...
        ILogger logger)
    {
        ...
        CloseNotificationsCommand = ReactiveCommand.Create(() =>
        {
            ...
            try
            {
                CurrentView = new KnowledgeBaseView
                {
                    DataContext = new KnowledgeBaseViewModel(
                        ...
                        _serviceProvider.GetRequiredService<IErrorHandlingService>())
                };
    ...
    public ReactiveCommand<System.Reactive.Unit, System.Reactive.Unit> CloseNotificationsCommand { get; private set; }
